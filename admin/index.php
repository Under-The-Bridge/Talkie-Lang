...
while ($row = mysqli_fetch_assoc($langsQ)) {
    $langsData[] = $row;
    if ($row['words_count'] > $maxLangWords) $maxLangWords = $row['words_count'];
}
?>
<!DOCTYPE html>
<html lang="en">
    ...
    <main class="container">
        ...
        <div class="dash-header">
            <div>
                ...
                <p class="dash-subtitle">Привет, <?= htmlspecialchars($user["user_login"] ?? "админ") ?>. Вот что происходит на платформе</p>
            </div>
        ...
        <div class="stats-grid">
            ...
            <div class="stat-box">
                <div class="stat-icon">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="4 7 4 4 20 4 20 7"/><line x1="9" y1="20" x2="15" y2="20"/><line x1="12" y1="4" x2="12" y2="20"/></svg>
                </div>
                <div>
            ...
            <div class="stat-box">
                <div class="stat-icon">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M8 21h8"/><path d="M12 17v4"/><path d="M7 4h10v5a5 5 0 0 1-10 0z"/><path d="M5 4H3v2a3 3 0 0 0 3 3"/><path d="M19 4h2v2a3 3 0 0 1-3 3"/></svg>
                </div>
                <div>
                    ...
                    <?php foreach ($langsData as $lang): ?>
                        <div class="lang-progress-row">
                            <div class="lang-progress-head">
                                <span class="lang-progress-name"><?= htmlspecialchars($lang['lang_name']) ?></span>
                                <span class="lang-progress-meta"><?= $lang['lessons_count'] ?> уроков · <?= $lang['words_count'] ?> слов</span>
                            </div>
                            <div class="lang-progress-bar">
                                <div class="lang-progress-fill" style="width: <?= round(($lang['words_count'] / $maxLangWords) * 100) ?>%"></div>
                            </div>
                        </div>
                    <?php endforeach; ?>
                </div>
